const carrierAliases = {
  'el al': 'LY', 'elal':'LY', 'ryanair':'FR', 'easyjet':'U2', 'wizz air':'W6', 'tap portugal':'TP', 'tap air portugal':'TP', 'air india':'AI', 'china airlines':'CI', 'china eastern':'MU', 'china southern':'CZ', 'air china':'CA', 'philippine airlines':'PR', 'cebu pacific':'5J', 'airasia':'AK', 'vietnam airlines':'VN', 'ethiopian airlines':'ET', 'ethiopian':'ET', 'egyptair':'MS', 'egypt air':'MS', 'royal air maroc':'AT', 'kenya airways':'KQ', 'kenya airway':'KQ', 'south african airways':'SA', 'south african airway':'SA', 'airlink':'4Z', 'flysafair':'FA', 'fly safair':'FA', 'air peace':'P4', 'rwandair':'WB', 'rwand air':'WB', 'asky airlines':'KP', 'asky':'KP', 'taag angola airlines':'DT', 'taag':'DT', 'air tanzania':'TC', 'uganda airlines':'UR', 'precision air':'PW', 'air algerie':'AH', 'air algérie':'AH', 'tunisair':'TU', 'air mauritius':'MK', 'air seychelles':'HM', 'air austral':'UU', 'lam mozambique airlines':'TM', 'air botswana':'BP', 'saudi arabian airlines':'SV', 'jet blue airways':'B6', 'british':'BA',
...
const airportAliases = {
  'tel aviv':['TLV'], 'ben gurion':['TLV'], 'toronto':['YYZ','YTZ'], 'vancouver':['YVR'], 'lisbon':['LIS'], 'istanbul':['IST','SAW'], 'zurich':['ZRH'], 'vienna':['VIE'], 'dublin':['DUB'], 'orlando':['MCO'], 'fort lauderdale':['FLL'], 'san diego':['SAN'], 'honolulu':['HNL'], 'denver':['DEN'], 'phoenix':['PHX'], 'detroit':['DTW'], 'minneapolis':['MSP'], 'salt lake city':['SLC'], 'charlotte':['CLT'], 'beijing':['PEK','PKX'], 'seoul':['ICN','GMP'], 'taipei':['TPE','TSA'], 'manila':['MNL'], 'auckland':['AKL'], 'cape town':['CPT'], 'johannesburg':['JNB'], 'nairobi':['NBO','WIL'], 'addis ababa':['ADD'], 'lagos':['LOS'], 'abuja':['ABV'], 'accra':['ACC'], 'dakar':['DSS'], 'cairo':['CAI'], 'casablanca':['CMN'], 'marrakech':['RAK'], 'algiers':['ALG'], 'tunis':['TUN'], 'kigali':['KGL'], 'entebbe':['EBB'], 'kampala':['EBB'], 'dar es salaam':['DAR'], 'zanzibar':['ZNZ'], 'mombasa':['MBA'], 'durban':['DUR'], 'gqeberha':['PLZ'], 'port elizabeth':['PLZ'], 'east london':['ELS'], 'harare':['HRE'], 'lusaka':['LUN'], 'windhoek':['WDH'], 'maputo':['MPM'], 'luanda':['LAD'], 'abidjan':['ABJ'], 'monrovia':['ROB'], 'freetown':['FNA'], 'banjul':['BJL'], 'bamako':['BKO'], 'ouagadougou':['OUA'], 'lome':['LFW'], 'lomé':['LFW'], 'cotonou':['COO'], 'douala':['DLA'], 'yaounde':['NSI'], 'yaoundé':['NSI'], 'kinshasa':['FIH'], 'brazzaville':['BZV'], 'khartoum':['KRT'], 'mauritius':['MRU'], 'seychelles':['SEZ'], 'antananarivo':['TNR'], 'lilongwe':['LLW'], 'blantyre':['BLZ'], 'gaborone':['GBE'], 'victoria falls':['VFA'], 'livingstone':['LVI'],
